...
const experience = [
    {
        ...
        description: "Developing full-stack features and REST APIs to support production applications using modern JavaScript ecosystems.",
        achievements: [
            "Developing full-stack features and REST APIs to support production applications",
            "Collaborating in an agile team environment with Git-based workflows",
            "Writing clean, maintainable JavaScript across backend and frontend layers",
            "Participating in code reviews and following software engineering best practices",
        ],
    },
];
