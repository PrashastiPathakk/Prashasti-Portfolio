...
graph TD
    ...
    subgraph "Infrastructure"
        ...
        subgraph "Application Logic"
            Backend --> devTinder[devTinder - Networking Engine]
            Backend --> HMS[HMS - Resource Management]
        end
        
        subgraph "Storage & Data"
            Backend --> DB[(MongoDB / NoSQL)]
            Backend --> Local[Local Storage - DSA Tracker]
        end
        
        Admin([Dashboard]) -.-> |Auth| Backend
    end

    classDef primary fill:#00FF88,stroke:#000,stroke-width:2px,color:#000;
    classDef secondary fill:#161b22,stroke:#00FF88,stroke-width:1px,color:#fff;
    classDef dark fill:#000,stroke:#333,stroke-width:1px,color:#444;
    
    class Frontend,Backend primary;
    class DB,devTinder,HMS secondary;
    class Admin,Local dark;
`;

const TechStack = [
    { name: 'Frontend', items: ['Next.js', 'React', 'Tailwind CSS', 'Framer Motion'] },
    { name: 'Backend', items: ['Node.js', 'Express.js', 'REST API', 'JWT'] },
    { name: 'Storage', items: ['MongoDB', 'Mongoose', 'localStorage', 'SQL'] },
